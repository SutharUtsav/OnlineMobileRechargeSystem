...
<body style="background-color:#00b3b3">
	...
	<div style="text-align: center" class="p-2 m-2">
            <asp:Label ID="Label" runat="server" CssClass="alert alert-danger"> * You Can Not Access This Page</asp:Label>

          
        </div>
            <asp:Button ID="ButtonLogout" CssClass="float-end btn bg-button" runat ="server" Text="Logout" OnClick="ButtonLogout_Click" />
                    ...
                    <div class="card shadow-2-strong card-registration bg-info gradient" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5 w-110">
                                ...
                                <asp:Panel ID="Panel1" runat="server" CssClass="alert alert-success alert-dismissible">
                                   <!-- <button type="button" class="btn-close" data-dismiss="alert" runat="server" OnClick="close_alert" aria-hidden="true"></button>
                                 -->   Your Recharche is Successfully Done
                                    <asp:Button ID="ButtonCloseAlert"  class="btn-close" data-dismiss="alert" aria-hidden="true" runat="server" OnClick="ButtonCloseAlert_Click" />
                                </asp:Panel>
        ...
        <div id="activePlan" class="py-5 bg-info bg-opacity-25 container h-100" runat="server">
            <div class="card text-center table-secondary">
                <div class="card-header" style="background-color:#f66f6f">
                    <h3 class="py-2" style="color:white">Your Active Plans</h3>
                </div>
