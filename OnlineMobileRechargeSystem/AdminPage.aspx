            ...
            <div class="page-content page-container" id="page-content">
                <div class="padding">
                    <div class="card">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-header text-white bg-dark">Admin Page</h3>
                                <div class="card-body">
                                        ...
                                        <label class="col-md-5 col-form-label-lg">Add New Packages :</label>
                                         <asp:HyperLink class="col-md-5 btn btn-dark" ID="HyperLink2" runat="server" NavigateUrl="~/AddPack.aspx">Add Pack</asp:HyperLink>
        ...
        <hr style="border:5px solid black"/>
         <asp:GridView CssClass="auto-style1"  ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Datapack" HeaderText="Datapack" SortExpression="Datapack" >
                    <ItemStyle BorderWidth="2px" BorderStyle="Groove" BorderColor="Black" HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="SMSLimit" HeaderText="SMSLimit" SortExpression="SMSLimit" >
                    <ItemStyle BorderWidth="2px" BorderStyle="Groove" BorderColor="Black" HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="Voice" HeaderText="Voice" SortExpression="Voice" >
                    <ItemStyle BorderWidth="2px" BorderStyle="Groove" BorderColor="Black" HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
