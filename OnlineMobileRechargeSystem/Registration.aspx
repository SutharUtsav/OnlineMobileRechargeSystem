            ...
            <h3 class="text-center">Registration Form</h3>
                  ...
                  <form id="form1" runat="server" class="mx-1 mx-md-4">
                    ...
                    <tr>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="PasswordTextBox" ErrorMessage="* (Password is required)" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"  ErrorMessage="* minimum length must be 8 <br/> * Contain at least one letter and one number" ForeColor="Red" Display="Dynamic" ControlToValidate="PasswordTextBox" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
