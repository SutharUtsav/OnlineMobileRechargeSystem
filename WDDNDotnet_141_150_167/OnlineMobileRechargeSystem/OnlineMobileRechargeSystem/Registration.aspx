            ...
            <h3 class="text-center">Registration Form</h3>
                  ...
                  <form id="form1" runat="server" class="mx-1 mx-md-4">
                    ...
                    <tr>
                        ...
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="EmailTextBox" ErrorMessage="<br/>You must enter the valid email Id" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="PhoneNumTextBox" ErrorMessage="<br/>You must enter valid 10 digit phone number" ForeColor="Red" ValidationExpression="\d{10}$" Display="Dynamic"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"  ErrorMessage="<br/>* minimum length must be 8 <br/>* Contain at least one letter and one number<br/>* No Special Symbols Allow" ForeColor="Red" Display="Dynamic" ControlToValidate="PasswordTextBox" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ConfirmPasswordTextBox" ErrorMessage="* (Confirm Password is required)" ForeColor="Red" ></asp:RequiredFieldValidator>
                               
                           
                               
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="PasswordTextBox" ErrorMessage="<br/>Both passwords must be same" ForeColor="Red" ControlToValidate="ConfirmPasswordTextBox" Display="Dynamic"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
